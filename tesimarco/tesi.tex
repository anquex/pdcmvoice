...
Hence we have three types of possible events, each one associated to its probability. Considering the whole window, the possible outcome of the transmissions consists in a tuple $(i,s,c)$ which satisfies $i+s+c=L$.
Hence, the probability to get $i$ idle slots, $s$ successful transmissions and $c$ collision is given by:
