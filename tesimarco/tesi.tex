...
\noindent Assume the scenario to be \emph{slotted}-ALOHA-like, unless otherwise specified.
...
\subsection{ \emph{m} Groups Tree esolution}
\marginpar{NUOVA}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.65]{matlab/BTs/m-groups-MBT-ALOHA}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.65]{matlab/BTs/m-groups-MBT-CSMA}
...
\section{IERC}
\section{Window Based Approaches}
