...
legend('T=10','T=20','T=30','Location','NorthEast');
...
set(gca,'XLim',[7 13]);
fh=figure(1);
title('Estimate distribution for $n=2^{10}$','Interpreter','Latex','FontSize', 14);
saveas(fh,'greenberg-mle-fixed-n-varying-T', 'epsc');