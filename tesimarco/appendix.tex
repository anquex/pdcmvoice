...
The following tables report the expected cost in slots to solve of a given size $n$ using BT, MBT, and CMBT. Performance reports in Chapter \ref{ch:Batch Resolution} plot these data.
\begin{table}[H]
...
Following table \ref{CBT-table-1} shows the behavior of CBT Algorithm (section \ref{cbt-estimation}) for estimation.  Simulation was implemented in matlab.
