...
public class RTCPSession {
    ...
    private static final Logger LOGGER =
        Logger.getLogger(RTCPSession.class.getName());
    ...
    protected void calculateDelay() {
        ...
        default:
            LOGGER.warning("RTCPSession.calculateDelay() unknown .mode");
        }
    }
    ...
    private boolean equivalent(RtcpPkt one, RtcpPkt two) {
        ...
        if(one.packetType == 205) {
            ...
            LOGGER.warning("!!!! RTCPSession.equivalentPackets() encountered unexpected packet type!");
        }
        return false;
    }
}
