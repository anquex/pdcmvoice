...
public class RtcpPktPSFB extends RtcpPkt {
    ...
    private static final Logger LOGGER =
        Logger.getLogger(RtcpPktPSFB.class.getName());
    ...
    public void debugPrint() {
        LOGGER.finest("->RtcpPktPSFB.debugPrint() ");
        ...
        case 2: // Slice Loss Indication
            ...
            LOGGER.finest("  FMT: Slice Loss Indication, " + str);
            break;
        case 3: // Reference Picture Selection Indication
        ...
        case 15: // Application Layer Feedback Messages
            ...
            LOGGER.finest("  FMT: Application Layer Feedback Messages, " + str);
            break;
        }
