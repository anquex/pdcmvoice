 ...
 * speaker.
 */
public class AudioLoopTest extends Thread {
     ...
     * Class constructor
     */
    public AudioLoopTest() throws LineUnavailableException {
    }
    ...
    public static final int BUFFER_SIZE_DEFAULT = 60;
    ...
    public static void main(String[] args) {
        try {
            AudioLoopTest audioLoop = new AudioLoopTest();
