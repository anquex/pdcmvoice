...
\begin{figure}[H]
  \centering 
  \subfloat[1. Tempi di calcolo assoluti in secondi tra le due implementazioni]{\includegraphics[width=0.40\textwidth]{immagini/confronto_sequenziale_tempi}}\quad   \subfloat[4. Guadagno dell'algoritmo ottimizzato]{\includegraphics[width=0.55\textwidth]{immagini/guadagno_sequenziale}}   
\end{figure}
...
Dai test condotti è emersa la critica dipendenza dell'algoritmo fft rispetto alla banda con la RAM. Infatti esso non gode di località spaziale e deve continuamente scorrere tutti gli elementi del vettore da elaborare.
