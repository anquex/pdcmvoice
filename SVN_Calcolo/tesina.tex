...
$$
\mathbf{W}_{N}=\mathbf{W}_{N}^T =(\mathbf{A}_{M}\mathbf{A}_{M-1} ... \mathbf{A}_{2}\mathbf{A}_{1}\mathbf{P}^T)^T = \mathbf{A}\mathbf{A}_{1}^T\mathbf{A}_{2}^T ... \mathbf{A}_{M-1}^T\mathbf{A}_{M}^T
$$
...
Dalla \eqref{eq:3.4} e \eqref{eq:3.5} segue che
$$
