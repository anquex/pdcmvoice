...
\begin{equation*}
	G[k] = \frac{1}{2} \left\{ Y[k] + Y^*[(-k)modN]\right \}
\end{equation*}
\begin{equation*}
	H[k] = \frac{1}{2j} \left\{ Y[k] - Y^*[(-k)modN]\right \}
\end{equation*}
...
\begin{figure}[h!]
  \centering
      \includegraphics[width=10cm,height=3cm]{immagini/circ-conv-mitra.jpg}
...
\begin{figure}[H]
  \centering
      \includegraphics[width=10cm,height=3cm]{immagini/lin-conv-mitra.jpg}
...
\begin{figure}[H]
  \centering
      \includegraphics[width=10cm,height=10cm]{immagini/overlap-add-mitra-1.jpg}
  \caption{Overlap-add (a) Sequenza di input (b) Suddivisioni di x(n)}
\end{figure}

\begin{figure}[H]
  \centering
      \includegraphics[width=10cm,height=7cm]{immagini/overlap-add-mitra-2.jpg}
  \caption{Overlap-add (c) $y_m(n) = h(n) \odot x_m(n)$}
\end{figure}
