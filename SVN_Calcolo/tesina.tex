...
$$
\mathbf{W}_{N}=\mathbf{W}_{N}^T =(\mathbf{A}_{M}\mathbf{A}_{M-1} ... \mathbf{A}_{2}\mathbf{A}_{1}\mathbf{P}^T)^T = \mathbf{P}\mathbf{A}_{1}^T\mathbf{A}_{2}^T ... \mathbf{A}_{M-1}^T\mathbf{A}_{M}^T
$$
...
Ovvero
\begin{equation*}
	\frac{\left\|\Delta X\right\|_2}{\left\|X\right\|_2}=O(log(N)c_N)
\end{equation*}
...
\paragraph{Fasi}
\begin{enumerate}
	\item Moltiplicazione dell'immagine originale p
\end{enumerate}
