package pdcmvoice.recovery;//prova
 ...
 * @author Antonio
 */
public class CopyOfRecoveryClientThreadOneBigBuffer extends Thread
{
    ...
    public CopyOfRecoveryClientThreadOneBigBuffer(RecoveryConnection RecConn)
	{
