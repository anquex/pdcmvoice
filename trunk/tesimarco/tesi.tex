...
Initially we fix a probability $p_{\epsilon}$ that determines how the initial batch is split the very first time.\\
...
\begin{figure*}[htb!]
    ...
    \end{tikzpicture}
    \caption[Basic greenberg batch split idea]{caption}
    \label{fig:sp2d}
\end{figure*}
