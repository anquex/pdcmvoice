...
Following Figures \ref{fig:greenberg-dist-small} and \ref{fig:greenberg-dist-large}
We note how, for any fixed $n$, the distribution is well behaved: initially it is monotonically increasing, then a monotonically decreasing part follows.\\
