...
\makebox[\textwidth][c]{% exchange [l] with [r] or [c] to extend it into the left border or both, respectively
 ...
 \caption[\emph{GEGA}: biased/unbiased absolute normalized estimate error]{\emph{GEGA}: biased/unbiased absolute normalized estimate error. The plot present $e(\hat{n})$ and $e(\tilde{n})$ for different $T$.}
...
Figure \ref{fg:GEGA-biased-unbiased} shows that the bias corrected estimate performs better than the biased estimate for any batch size and $T$.
\chapter{Comparison}
