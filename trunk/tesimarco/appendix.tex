...
The resulting distribution of $\hat{n}$ fixed $n$ is the result of averaging 10$0^{\cdot}$000 runs of CBT Algorihm applied on uniformly random generated nodes ID batches.\\ 
